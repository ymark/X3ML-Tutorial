...
According to the conceptual map (that is given in Appendix A), these instances are connected using the property ```P102_has_title``` from CIDOC CRM.
...
### Appendix B - Source Data Elements Mappigns
